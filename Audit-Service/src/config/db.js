...
const initializeDatabase = async () => {
  await pool.execute(
    [
      ...
      "actor_role ENUM('anonymous', 'user', 'admin', 'supplier', 'system') NOT NULL DEFAULT 'anonymous',",
      ...
      "UNIQUE KEY uniq_audit_domain_offset (source_topic, source_partition, source_offset),",
      "UNIQUE KEY uniq_audit_activity_request (service_name, request_id, http_method, http_path, http_status)",
      ")",
    ].join(" "),
  );
};
