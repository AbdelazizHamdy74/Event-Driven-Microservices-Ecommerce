...
const { requestLogger, healthHandler, metricsHandler } =
  createObservability("product-service");
...
const shutdown = async (signal) => {
  console.log(`[product-service] ${signal} received, shutting down`);
  ...
  try {
    ...
    console.error("[product-service] graceful shutdown failed", err);
    process.exit(1);
  }
};
